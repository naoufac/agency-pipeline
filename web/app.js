...
function roadmap(){
  const P = [
    ...
    { n:'15', t:'M1 · Landing pages that sell', s:'next', d:'One focused sales page per landing brief — pain → promise → proof → offer → CTA. New proof/offer components, conversion copy patterns, a landing shape in the planner. Done = exactly 1 page, ≥2 conversion sections, every gate green.' },
